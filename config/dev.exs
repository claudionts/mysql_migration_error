...
config :mysql_migration_error_phx, MysqlMigrationErrorPhxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vO18pjnXzmnyjyFmKyW3cWQGfYxtd8nltYxdSqXfjKwjgtsftIrOUPf6lAHkiUFd",
  watchers: [
    esbuild:
      {Esbuild, :install_and_run, [:mysql_migration_error_phx, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:mysql_migration_error_phx, ~w(--watch)]}
  ]
...
config :mysql_migration_error_phx, dev_routes: true
